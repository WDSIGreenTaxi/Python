...
def find_hist():
    if flask.request.method == 'GET':
        vals = joblib.load('/Users/joey/code/wdi/hackathon/Python/value_dict','r')
...
def find_fare():
    if flask.request.method == 'POST':
        ...
        file = '/Users/joey/code/wdi/hackathon/Python/Models/pickled_' + file_name;
        ...
        for hour in range(24):
            ...
            rates_by_hour.append({'hour': hour, 'price':prediction})
